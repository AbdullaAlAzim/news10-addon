    ...
    if ( 'section' === $element->get_name() && 'section_custom_css_pro' === $section_id ) {
        ...
        $element->start_controls_section(
            ...
            [
                ...
                'label' => __( 'News10 Settings', 'news10' ),
            ]
        );
        ...
        $element->add_control(
            'header_sticky',
            [
                'label'        =>   __( 'Sticky Section', 'news10' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     =>   __( 'Yes', 'news10' ),
                'label_off'    =>   __( 'No', 'news10' ),
                'return_value' => 'news10-sticky-header',
                'default'      => '',
                'prefix_class' => '',
            ]
        );
        $element->add_group_control(
            ...
            [
                ...
                'show_label' => true,
                'condition' => [
                    'header_sticky' => 'news10-sticky-header'
                ],
                'selector' => '{{WRAPPER}}.news10-sticky-header.sticky-on',
            ]
        );
        ...
        $element->add_responsive_control(
            '_element_width',
            [
                'label' => __( 'Width', 'news10' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'news10' ),
                    'inherit' => __( 'Full Width', 'news10' ) . ' (100%)',
                    'auto' => __( 'Inline', 'news10' ) . ' (auto)',
                    'initial' => __( 'Custom', 'news10' ),
                ],
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => __( 'Vertical Align', 'news10' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => __( 'Start', 'news10' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'center' => [
                        'title' => __( 'Center', 'news10' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => '<strong>' . __( 'Please note!', 'news10' ) . '</strong> ' . __( 'Custom positioning is not considered best practice for responsive web design and should not be used too frequently.', 'news10' ),
        ...
        $element->add_control(
            '_position',
            [
                'label' => __( 'Position', 'news10' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'news10' ),
                    'absolute' => __( 'Absolute', 'news10' ),
                    'fixed' => __( 'Fixed', 'news10' ),
                ],
        ...
        $start = is_rtl() ? __( 'Right', 'news10' ) : __( 'Left', 'news10' );
        $end = ! is_rtl() ? __( 'Right', 'news10' ) : __( 'Left', 'news10' );

        $element->add_control(
            '_offset_orientation_h',
            [
                'label' => __( 'Horizontal Orientation', 'news10' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Vertical Orientation', 'news10' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
...
add_action( 'elementor/element/heading/section_title_style/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'text_transparent',
        [
            'label'        =>   __( 'Transparent', 'news10' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'news10' ),
            'label_off'    =>   __( 'No', 'news10' ),
            'return_value' => 'news10-text-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'condition' => [
                'text_transparent' => 'news10-text-gradient'
            ],
            'selector' => '{{WRAPPER}}.news10-text-gradient .elementor-heading-title',
        ]
    );
    $element->add_control(
        'text_sr',
        [
            'label' => __( 'Text Stroke', 'news10' ),
            'type' => \Elementor\Controls_Manager::HEADING,
        ]
    );
    $element->add_control(
        'text_str',
        [
            'label'        =>   __( 'Turn On Stroke', 'news10' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'news10' ),
            'label_off'    =>   __( 'No', 'news10' ),
            'return_value' => 'news10-text-stroke',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        's_fill_color',
        [
            'label' => __( 'Fill Color', 'news10' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'news10-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.news10-text-stroke .elementor-heading-title' => '-webkit-text-fill-color: {{VALUE}}',
            ],
        ]
    );
    $element->add_responsive_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}}.news10-text-stroke .elementor-heading-title' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
            ],
            'condition' => [
                'text_str' => 'news10-text-stroke'
            ],
    ...
    $element->add_control(
        's_text_color',
        [
            'label' => __( 'Stroke Color', 'news10' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'news10-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.news10-text-stroke .elementor-heading-title' => '-webkit-text-stroke-color: {{VALUE}}',
            ],
        ]
    );
    $element->end_controls_section();
...
add_action( 'elementor/element/button/section_style/before_section_start', function( $element, $args ) {
    ...
    $element->start_controls_section(
        ...
        [
            'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            'label' => __( 'News10 Settings', 'appilo' ),
        ]
    );
...
add_action( 'elementor/element/icon/section_style_icon/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'icon_light_box',
        [
            'label'        =>   __( 'Turn On LightBox', 'news10' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'news10' ),
            'label_off'    =>   __( 'No', 'news10' ),
            'return_value' => 'news10-icon-lightbox',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        'icon_gradient',
        [
            'label'        =>   __( 'Turn On Gradient', 'news10' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'news10' ),
            'label_off'    =>   __( 'No', 'news10' ),
            'return_value' => 'news10-icon-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    ...
    $element->start_controls_tab(
        ...
        [
            'label' => __( 'Normal', 'appilo' ),
            'condition' => [
                'icon_gradient' => 'news10-icon-gradient'
            ],
        ]
    );
    $element->add_control(
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.news10-icon-gradient .elementor-icon i',
        ]
    );
    $element->add_control(
        'atext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.news10-icon-gradient .elementor-icon',
        ]
    );
    $element->end_controls_tab();
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.news10-icon-gradient .elementor-icon:hover i',
        ]
    );
    $element->add_control(
        'afatext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.news10-icon-gradient .elementor-icon:hover',
        ]
    );
    $element->end_controls_tab();
...
function news10element_template_select() {
...
/*Meta Fields*/
function news10element_animations(){
    return array(
        '' => esc_html__('No animation', 'news10element') ,
        'reveal-top' => esc_html__('Animate from top', 'news10element') ,
        'reveal-bottom' => esc_html__('Animate from bottom', 'news10element') ,
        'reveal-left' => esc_html__('Animate from left', 'news10element') ,
        'reveal-right' => esc_html__('Animate from right', 'news10element') ,
    );  
}
...
function news10element_gird_column($column_size = '3') {
...
function news10element_gallery_column($column_size = 3) {
...
function news10_page_title($arg){
        ...
        if ( is_category() ) {
          ...
          $title = esc_html__( 'Frontpage', 'news10' );
        } elseif( is_singular() ){
          $title = get_the_title();
        }else {
            $title = esc_html__( 'Archives','news10' );
        }
