...
class food_lastest_recepe extends Widget_Base
{

    public function get_name()
    {
        return 'news10recipes';
    }

    public function get_title()
    {
        return __('Food latest Recipes', 'news10');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('Food latest Recipes', 'news10'),
            ...
            <div class="row">
                ...
                <?php 
                    ...
                    <div class="load-more-btn-wrapper">
                        <a href="<?php echo get_post_type_archive_link( 'post' ); ?>" class="btn news10-food-white-btn"> <?php esc_html_e('Load More','news10'); ?></a>
                    </div>
            </div>
        </div>
    </section>
...
Plugin::instance()->widgets_manager->register_widget_type(new food_lastest_recepe());?>
