...
class news10_news_pick_post extends Widget_Base {

    public function get_name() {
        return 'news10editorpost';
    }
 
    public function get_title() {
        return __('Editors Picks Post', 'news10');
    }
    ...
    protected function render()
    {
     ...
     $wp_query = new \WP_Query($query_args);
      ...
      ?>
<!-- news10 Editors Post Start -->
 <section class="news10-editors-post news10-section">
                <div class="container">
                    <div class="news10-title-line">
                        <h2><?php echo $settings['title'];?></h2>
                    </div>
                    <div class="news10-editor-grid">
                        ...
                        <?php 
                              $loop = 0;
                                ...
                                $loop++;
                                   if($loop==1){
                                    $cls = 'card news10-default-post';
                                   
                                }elseif($loop==2){
                                    $cls = 'card news10-default-post big-wide';
...
<!-- news10 Editors Post End -->
    <?php 
   
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new news10_news_pick_post() );
?>