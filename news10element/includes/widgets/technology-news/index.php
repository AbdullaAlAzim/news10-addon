...
class news10_technology_blog extends Widget_Base {

    public function get_name() {
        return 'news10technologyblog';
    }
 
    public function get_title() {
        return __('Technology Blogs', 'news10');
    }
    ...
    $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .news10-title::after',
            ]
        );
    ...
    protected function render()
    {
     ...
     $wp_query = new \WP_Query($query_args);
      ...
      ?>
        ...
        <!-- news10 Technology News Start -->
            <div class="news10-technology-news-section news10-section">
                <div class="container">
                    <div class="news10-title-center v2">
                        <div class="news10-title-icon"></div>
                        <div class="news10-title-text">
                            <h2><?php esc_html_e('Technology News','news10'); ?></h2>
                        </div>
                        <div class="news10-title-icon"></div>
                    </div>
                    <div class="row">
                                ...
                                $loop++;
                                   if($loop==1){
                                    ...
                                    $cls = 'col-lg-6';
                                     ...
                                     $cls = 'col-lg-3 col-md-6';
                                     $imagecalss = 'image_size';
                            ...
                            <div class="card news10-default-post big-card">
                                <div class="news10-post-img">
                                 <?php 
                                     ...
                                     the_post_thumbnail('full', ['class' => $imagecalss, 'title' => 'Feature image']);
                                       }
                                    ?>
                                </div>
            ...
            <!-- news10 Technology News End -->

    <?php 
   
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new news10_technology_blog() );
?>