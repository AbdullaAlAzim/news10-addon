<section class="news10-info-footer">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-2">
                <div class="logo">
                       <a href="<?php echo home_url('/');?>"><?php echo  get_that_image($settings['fo_logo']); ?></a>
                </div>
            </div>
            <div class="col-lg-10">
                <div class="news10-text">
                    <h6><?php echo esc_html($settings['top_con']); ?></h6>
                </div>
            </div>
        </div>
        <div class="row news10-link-footer">
            ...
            <div class="col-sm-6 col-md-4 col-lg-2">
                ...
                <div class="news10-news-link">
                    <ul>
                    	 <?php if(($settings['member_list']) ): foreach ($settings['member_list'] as $mem):?>
                        <li><a href="<?php echo ($mem['linkds']['url']); ?>"><?php echo ($mem['menu_text']); ?></a></li>
            ...
            <div class="col-sm-6 col-md-4  col-lg-2">
                ...
                <div class="news10-news-link">
                    <ul>
                    	 <?php if(($settings['member_listt']) ): foreach ($settings['member_listt'] as $members):?>
                        <li><a href="<?php echo ($members['linkk']['url']); ?>"><?php echo ($members['textt']); ?></a></li>
                              <?php endforeach; endif; ?>
        ...
        <div class="news10-main-footer">
            <h6><?php echo $settings['cop_right']; ?></h6>
        </div>
    </div>
</section>