<section class="news10-info-footer news10-tech-footer news-footer" data-background="<?php echo $settings['se_bg']['url']; ?>">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="logo">
                     <a href="<?php echo home_url('/');?>"><?php echo  get_that_image($settings['fo_logoo']); ?></a>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="news10-text">
                    <h6><?php echo esc_html($settings['top_conn']); ?></h6>
                </div>
            </div>
        </div>
        <div class="row news10-link-footer">
            <div class="col-lg-4">
                ...
                <div class="news10-news-list">
                    <ul>
                         ...
                         <?php 
                    if($popularpost2->have_posts()) : while($popularpost2->have_posts()) : $popularpost2->the_post();?>
                        <li>
            ...
            <div class="col-sm-6 col-lg-2">
                <div class="news10-title mt-40">
                    <div class="news10-title-text">
                       <h2><?php esc_html_e('World News','news10'); ?></h2>
                    </div>
                </div>
                <div class="news10-news-link">
                    <ul>

                        <?php if(($settings['membeer_list']) ): foreach ($settings['membeer_list'] as $members):?>
                        <li><a href="<?php echo ($members['linnk']['url']); ?>"><?php echo ($members['texxt']); ?></a></li>
            ...
            <div class="col-sm-6  col-lg-2">
                <div class="news10-title">
                    <div class="news10-title-text">
                         ...
                         <h2><?php esc_html_e('About Magpie','news10'); ?></h2>
                    </div>
                </div>
                <div class="news10-news-link">
                    <ul>

                         <?php if(($settings['mmember_listt']) ): foreach ($settings['mmember_listt'] as $members):?>
                        <li><a href="<?php echo ($members['linkkm']['url']); ?>"><?php echo ($members['texttm']); ?></a></li>
                              <?php endforeach; endif; ?>
        ...
        <div class="news10-main-footer">
              ...
              <h6><?php echo $settings['ccop_right']; ?></h6>
        </div>
    </div>
</section>
