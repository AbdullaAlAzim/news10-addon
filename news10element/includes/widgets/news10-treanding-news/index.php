...
class news10_news_bann_treanding extends Widget_Base {

    public function get_name() {
        return 'news10newstreanding';
    }
 
    public function get_title() {
        return __('Treanding news', 'news10');
    }
    ...
    $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .card .news10-card-body .news10-text .news10-item-text, {{WRAPPER}} .card .news10-card-body .news10-text .news10-item-text a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .card .news10-card-body .news10-text .news10-item-text, {{WRAPPER}} .card .news10-card-body .news10-text .news10-item-text a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,    
                'selectors' => [
                    '{{WRAPPER}} .card .news10-card-body .news10-text h4' => 'color: {{VALUE}}',
                ],
            ]
        );
           ...
           $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .card .news10-card-body .news10-text h4',
            ]
        );
    ...
    protected function render()
    {
     ...
     $wp_query = new \WP_Query($query_args);
      ...
      ?>
                                ...
                                <div class="card news10-over-img-post">
                                    <div class="news10-post-img">
                                       <?php 
                                         ...
                                         the_post_thumbnail('news10-point-306-174');
                                           }
                                        ?>
                                    </div>
                                        ...
                                        <div class="news10-text">
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <span class="news10-item-text"><a href="<?php echo esc_url( get_category_link( $categories[0]->term_id ) );?>"><?php echo get_the_author()?></a></span>
                                                </li>
                                                <li>
            ...
            <!-- news10 Trending News End -->
    <?php 
   
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new news10_news_bann_treanding() );
?>