...
class fasion_recent_post_side extends Widget_Base
{

    public function get_name()
    {
        return 'recentpostsidefasion';
    }

    public function get_title()
    {
        return __('Fasion Recent Post sidebar', 'news10');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,    
                'selectors' => [
                    '{{WRAPPER}} .news10-single-post .title, {{WRAPPER}} .news10-fashion-wedgets .heading-title h4' => 'color: {{VALUE}}',
                ],
            ]
        );
           ...
           $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .news10-single-post .title, {{WRAPPER}} .news10-fashion-wedgets .heading-title h4',
            ]
        );
 ...
 <div class="news10-wedgets-area fashion-wedgets-area">
        <div class="widgets news10-wedgets-recent-post news10-fashion-wedgets mt-0">
...
Plugin::instance()->widgets_manager->register_widget_type(new fasion_recent_post_side());?>
