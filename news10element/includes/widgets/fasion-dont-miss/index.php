...
class news10_fasion_dont_miss extends Widget_Base {

    public function get_name() {
        return 'fasiondontmiss';
    }
 
    public function get_title() {
        return __('fasion Dont Miss', 'news10');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('fasion Dont Miss', 'news10'),
    ...
    $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,    
                'selectors' => [
                    '{{WRAPPER}} .news10-sm-post-categories .news10-post-content .title' => 'color: {{VALUE}}',
                ],
            ]
        );
           ...
           $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .news10-sm-post-categories .news10-post-content .title',
            ]
        );
    ...
    protected function render()
    {
     ...
     $wp_query = new \WP_Query($query_args);
      ...
      ?>
<section class="news10-dont-miss-section news10-section">
        <div class="container">
            <div class="news10-fashion-header text-center">
                <h2 class="heading-title bg-white"><?php esc_html_e('Dont Miss','news10'); ?></h2>
            </div>
            <div class="row">
                 <?php 
                    if($wp_query->have_posts()) : while($wp_query->have_posts()) : $wp_query->the_post();?>
                <div class="col-lg-3 col-md-6">
                    <div class="news10-sm-post-categories news10-effect-wraper mt-4 mb-0">
...
Plugin::instance()->widgets_manager->register_widget_type( new news10_fasion_dont_miss() );
?>