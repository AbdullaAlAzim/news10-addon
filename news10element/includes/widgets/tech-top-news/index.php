...
class tech_top_news extends Widget_Base {
    ...
    public function get_title() {
        return __('Tech Top News', 'news10');
    }
    ...
    $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .card.news10-card-img .news10-text li .news10-item-text, {{WRAPPER}} .card.news10-card-img .news10-text li .news10-item-text a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,  
                'selectors' => [
                    '{{WRAPPER}} .card.news10-card-img .news10-text h4 a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .card.news10-card-img .news10-text h4 a',
            ]
        );
    ...
    protected function render()
    {
     ...
     $wp_query = new \WP_Query($query_args);
      ...
      ?>
    <!-- news10 Top News Start -->
            <div class="news10-top-news-section news10-section">
                <div class="container">
                    <div class="row">
                          <?php 
                              $loop = 0;
                        ...
                        <div class="<?php echo $cls; ?>">
                            <div class="card news10-card-img topnews-card topnews-big">
                            <?php 
                            ...
                            ?>
                                <div class="card-body news10-card-body">
                                    <span class="<?php echo $color; ?>"><?php news10_loop_category(); ?></span>
                                    <div class="news10-text">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span class="news10-item-text"><a href="#"><?php news10_loop_category(); ?></a></span>
                                            </li>
                                            <li>
...
Plugin::instance()->widgets_manager->register_widget_type( new tech_top_news() );
?>