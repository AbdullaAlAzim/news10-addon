...
class food_cat_sidebar extends Widget_Base
{
    public function get_name()
    {
        return 'foodcatsidebar';
    }

    public function get_title()
    {
        return __('Food Sidebar Category', 'news10');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('Food Sidebar Category', 'news10'),
        ...
        $this->add_control(
          ...
          $this->add_control(
            'post_title_colorhv',  
            [
                'label' => __('Category Hover Color', 'news10'),
                'type' => \Elementor\Controls_Manager::COLOR,    
                'selectors' => [
                    '{{WRAPPER}} .news10-food-categories-wedgets a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
 ...
 <div class="news10-food-wedgets-area">
   <div class="widgets news10-wedgets-categories news10-food-categories-wedgets">
...
Plugin::instance()->widgets_manager->register_widget_type(new food_cat_sidebar());
?>