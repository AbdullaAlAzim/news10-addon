...
class food_lastest_post extends Widget_Base
{

    public function get_name()
    {
        return 'news10latestpost';
    }

    public function get_title()
    {
        return __('Food latest post', 'news10');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('Food latest post', 'news10'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Latest Posts', 'news10' ),
            ]
        );
         ...
         $this->add_control(
            'info_details',
            [
                'label' => __( 'Section Summary', 'news10' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => __( 'Looking for some cooking inspiration? Below are our newly developed recipes for any occasion – check out and try them!', 'news10' ),
            ]
        );
        $this->add_control(
            'query_type',
    ...
    $this->start_controls_section(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,    
                'selectors' => [
                    '{{WRAPPER}} .news10-food-heading .heading-title, {{WRAPPER}} .news10-food-heading p, {{WRAPPER}} .news10-food-card .news10-food-card-body .card-title' => 'color: {{VALUE}}',
                ],
            ]
        );
           ...
           $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .news10-food-heading .heading-title, {{WRAPPER}} .news10-food-heading p, {{WRAPPER}} .news10-food-card .news10-food-card-body .card-title',
            ]
        );
  ...
  <!-- Latest Posts section start  -->
    <section class="news10-food-latest-posts-section news10-section">
        <div class="container">
            <div class="news10-food-heading">
                <h2 class="heading-title"><?php esc_html_e($settings['title']); ?></h2>
                <p><?php esc_html_e($settings['info_details']); ?></p>
            </div>
            <div class="row">
                <?php 
                    if($wp_query->have_posts()) : while($wp_query->have_posts()) : $wp_query->the_post();?>
                <div class="col-lg-4 col-sm-6">
                    <div class="card news10-food-card news10-sm-food-card news10-effect-wraper">
                        ...
                        <div class="card-body news10-food-card-body">
                            <span class="news10-food-ctg"><?php news10_loop_category(); ?></span>
                            ...
                            <div class="news10-meta-info news10-food-meta">
                                ...
                                <div class="post-review">
                                    <span> <?php echo like_it_button_html('');?> </span>
...
Plugin::instance()->widgets_manager->register_widget_type(new food_lastest_post());?>
